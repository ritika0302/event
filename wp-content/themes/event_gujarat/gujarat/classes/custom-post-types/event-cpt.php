                    ...
                    function setMarkers(map) {
                     var infowindow = new google.maps.InfoWindow();
                        for (var i = 0; i < points.length; i++) {
                            ...
                            // console.log('---start-----');
                            // console.log(point[9]);
                            var text_comment = point[9];
                            var p_comment = '';
                            if(text_comment){            
                                // jQuery('.map_dynamic').addClass('ddddd');
                                if(text_comment.length > maxL) {
                                    // var newStr = text_comment.substring(0, maxL);

                                    var p_comment = '<li><span class="comment"><i class="fa fa-comment-o" aria-hidden="true"></i> <strong>Comment:</strong> <p class="content">'+text_comment+'</p></span></li>';
                                }
                            ...
                            var contentString = '<div class="marker-infowindow"><ul class="map_dynamic">' +
                                                '<h2>'+point[3]+'</h1>'+
                        ...
                        // jQuery('.map_dynamic').addClass('sssssssssssssss');
...
<div class="modal fade" id="addComment" tabindex="-1" role="dialog" aria-labelledby="addCommentTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <h5 class="modal-title" id="addCommentTitle">Comment</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <div class="alert alert-success addcomm-messages" role="alert" style="display: none;">
                  <div class="error-messages"></div> 
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="alert alert-danger addcomm-error" role="alert" style="display: none;">
                  <div class="error-messages"></div> 
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                ...
                <form id="addComm">
                  <label for="commentname">Your Comment is</label>
                  <textarea id="commenttext" name="comment" ><?php get_field('comment' );?></textarea>
                </form>
            </div>
          </div>
        </div>
